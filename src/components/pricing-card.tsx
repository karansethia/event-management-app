...
export default function PricingCard({ description, features, link, pricing, title }: Props) {
  return (
    <div className="bg-gray-100 dark:bg-[#262626] rounded-3xl p-2 shadow-[0_12px_50px_-15px_rgba(0,0,0,0.1)] font-content tracking-wide dark:shadow-[0_12px_50px_-15px_rgba(0,0,0,0.25)] border border-gray-200/60 dark:border-gray-700/60 flex flex-col">
      <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl p-8 mb-2">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 font-header">{title}</h2>
        ...
        <Link href={link}>
          <button className="w-full bg-green-500 dark:bg-green-500 cursor-pointer text-white dark:text-gray-900 py-3 rounded-full font-semibold text-base hover:opacity-90 transition-opacity duration-200 flex items-center justify-center gap-2.5 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.2)] dark:shadow-[0_4px_20px_-5px_rgba(255,255,255,0.2)]">
            Subscribe
          </button>
        </Link>
      </div>
